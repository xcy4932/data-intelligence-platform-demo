...
<template>
  <n-spin :show="loading">
    <v-chart v-if="result?.timeSeries.length" class="event-chart" :option="option" autoresize />
    <n-empty v-else description="暂无堆叠图数据" />
  </n-spin>
</template>
